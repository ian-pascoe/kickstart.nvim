...
function M.info()
  ...
  lines[#lines + 1] = '```'
  SpiritVim.info(lines, { title = 'Roots' })
...
function M.setup()
  ...
  vim.api.nvim_create_autocmd({ 'LspAttach', 'BufWritePost', 'DirChanged', 'BufEnter' }, {
    group = vim.api.nvim_create_augroup('spiritvim_root_cache', { clear = true }),
...
function M.get(opts)
  ...
  return SpiritVim.is_win() and ret:gsub('/', '\\') or ret
end
