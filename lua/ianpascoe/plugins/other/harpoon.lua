return {
  ...
  config = function()
    ...
    Util.keymap.set('n', '<leader>ha', harpoon_mark.add_file, { desc = '[A]dd file' })
    Util.keymap.set('n', '<leader>hh', harpoon_ui.toggle_quick_menu, { desc = 'Toggle' })
    Util.keymap.set('n', '<leader>hs', '<CMD>Telescope harpoon marks<CR>', { desc = '[S]earch marked' })
    Util.keymap.set('n', '[h', harpoon_ui.nav_prev, { desc = 'Harpoon: navigate prev' })
    Util.keymap.set('n', ']h', harpoon_ui.nav_next, { desc = 'Harpoon: navigate next' })
